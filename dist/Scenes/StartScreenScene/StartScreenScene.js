...
var StartScreenScene = /** @class */ (function () {
    function StartScreenScene() {
        this._startScene();
    }
    StartScreenScene.prototype._startScene = function () {
        return __awaiter(this, void 0, void 0, function () {
            var startGameBtn, loadGameBtn, menuContainer;
            var _this = this;
            return __generator(this, function (_a) {
                startGameBtn = new ControlButton("Start", "width:100%;");
                loadGameBtn = new ControlButton("Load", "width:100%;");
                startGameBtn.bindFunc(function () {
                    Screen.delete();
                    new UserCreationScene();
                });
                loadGameBtn.bindFunc(function () { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, LoadGame()];
                            case 1:
                                _a.sent();
                                Screen.delete();
