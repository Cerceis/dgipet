...
export class BattleStatusPanel {
    constructor(char) {
        ...
        this.ele_infoCon = document.createElement("div");
        this.ele_name = document.createElement("div");
        this.ele_level = document.createElement("div");
        this.ele_healthBar = document.createElement("div");
        this.ele_healthBarInner = document.createElement("div");
        this.ele_healthInfo = document.createElement("span");
        this.ele_manaBar = document.createElement("div");
        this.ele_manaBarInner = document.createElement("div");
        this.ele_manaInfo = document.createElement("span");
        this.ele_statusBarCon = document.createElement("div");
        this.statusList = [];
