...
class _Snackbar{
	...
	constructor(title: string, content: string, top: string = "0px"){
		...
		const titleEle: HTMLDivElement = document.createElement("div");
		const titleEleStyle: string = `
			font-size:12px;
			padding-top: .7em;
			padding-bottom: .2em;
			padding-left: .8em;
		...
		const hrEle: HTMLDivElement = document.createElement("hr");
		const hrEleStyle: string = `
			width: 180px;
			margin: 0 9px;
			opacity: .2;
		`
...
export class ControlSnackbar {
	...
	public add( title: string = "", content: string = "", life: number = 0): void{
